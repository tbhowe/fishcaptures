...
#         self.lat = lat
#         self.lng = lng
#         endpoint = f"{self.BASE_URL}?latitude={self.lat}&longitude={self.lng}&hourly=temperature_2m,cloudcover_low,cloudcover_mid,cloudcover_high,windspeed_10m,winddirection_10m&timezone=Europe%2FLondon"
...
#             "temperature_2m (°C)": matching_row.loc[0, 'temperature_2m'],
#             "wind_speed_10m (km/h)": matching_row.loc[0, 'windspeed_10m'],
#             "wind_direction_10m (°)": matching_row.loc[0, 'winddirection_10m'],
#             "cloudcover_low (%)": matching_row.loc[0, 'cloudcover_low'],
#             "cloudcover_mid (%)": matching_row.loc[0, 'cloudcover_mid'],
#             "cloudcover_high (%)": matching_row.loc[0, 'cloudcover_high']
#         }
